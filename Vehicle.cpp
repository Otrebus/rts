...
real Vehicle::getTime(real v, real a_f, real a_r, real maxV, real d)
{
    real ret = 0;
    if(v < 0)
    {
...
std::pair<bool, int> Vehicle::getmoveDir(Vector2 dest, Vector2 geoDirection, Vector2 geoVelocity, real maxV, real a_f, real a_r, real a_b, real turnRadius)
{
    if(!dest)
